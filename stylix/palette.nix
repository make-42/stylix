    ...
    assertions = [
      {
        ...
        message =
          "stylix: base16 palette is null after applying mappingFunction. "
          + "Set stylix.palette.generators.base16, stylix.palette.manual.base16, "
          + "or a mappingFunction that derives base16 from another scheme.";
      }
    ];
